...
import "github.com/ByteTheCookies/cookieserver/internal/sqlite"

// ResponseFlags represents the response for the flags api
type ResponseFlags struct {
	Nflags int           `json:"n_flags"`
	Flags  []sqlite.Flag `json:"flags"`
}
...
type ViewParamsFlags struct {
	Flags []sqlite.Flag `json:"flags"` // List of flags to display
}
